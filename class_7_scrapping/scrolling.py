...
url = "https://www.daraz.com.bd/?spm=a2a0e.home.header.dhome.2dca12f7PaxdRv"  # Replace with the URL of the website you want to scrape
driver.get(url)

click_electronics = driver.find_element(By.LINK_TEXT, "Electronic Accessories").click

window.after(10000, lambda: None)
